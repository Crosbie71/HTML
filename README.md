...
A collection of interactive, browser-based tools for teaching — primarily A-Level English Language (AQA 7702) but with apps useful across subjects. Everything runs in the browser: no installation, no login, no data leaving the device.

**Browse and launch all apps: [index.html](index.html)**
...
**[GenresFlashcards.htm](GenresFlashcards.htm)** — Sixteen genre names drawn as single cards or pairs from a shuffled deck. A good quick demo of what the simpler tools in this collection look like in practice.

**[PhonemicRevision.html](PhonemicRevision.html)** — The full Underhill phonemic chart as an interactive jigsaw. Drag phoneme tiles onto the correct positions with instant feedback, optional colour-coding by category, and voicing shading for consonants.

**[ALExamRevPlanner.html](ALExamRevPlanner.html)** — A full summer exam revision planner covering the 2026 A-Level and vocational schedule. Select your subjects and get an auto-generated revision timetable with drag-and-drop blocks and print-to-PDF output.
...
Apps are added and updated informally — this README describes the general shape of the collection rather than providing a complete or necessarily current inventory. The portal at [index.html](index.html) always reflects what's actually in the repository.
